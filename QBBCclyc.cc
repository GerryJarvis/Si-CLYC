...
QBBCclyc::QBBCclyc(G4int ver, const G4String &)
{
  if (ver > 0)
    G4cout << "<<< Reference Physics List QBBCclyc " << G4endl;
 ...
 // RegisterPhysics(new G4OpticalPhysics(ver));
  ...
  stepLimitPhys->SetApplyToAll(true); // activates step limit for ALL particles 否则将只对带电粒子生效
